...
public class ExceptionDialog extends JDialog {
    ...
    /**
     * create and show a modal error dialog.
     * 
     * @param owner owner of the dialog
     * @param errorMessage The message to printed in the window
     * @param ex Exception to make the detailed message from
     * @param second optional button caption. null if no second button desired
     * @return true if second button was visible and pressed
     */
