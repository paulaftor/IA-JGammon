...
public class ConsoleFrame extends JFrame {
    ...
    public static void commandline(ConsoleApp t, String message) throws IOException {
        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
        PrintWriter dbgWriter = new PrintWriter(System.out, true);
        t.setLog(dbgWriter);
        dbgWriter.println(message);
        while (true) {
            dbgWriter.print("> ");
            dbgWriter.flush();
            ...
            try {
                if (!t.command(c)) {
                    dbgWriter.println("Unknown command \"" + c + "\"");
                }
            } catch (Exception ex) {
