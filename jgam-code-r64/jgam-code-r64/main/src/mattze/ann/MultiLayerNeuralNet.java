...
public class MultiLayerNeuralNet implements Serializable, NeuralNet {
     ...
     */
    private static final long serialVersionUID = 7927445264206085664L;
    ...
    // the number of trained instances
    private long numberOfTrainedInstances;
    ...
    public void addLayer(Layer layer) throws IllegalStateException {
        if(inLayer == null) {
            throw new IllegalStateException("No input layer set");
        }
    ...
    public long getTrainCount() {
        return numberOfTrainedInstances;
    }
