...
public class SigmoidLayer extends Layer {
    ...
    /**
     * serial number for saving and loading.
     * Must be adapted if data structures change
     */
    private static final long serialVersionUID = -9156953946141316098L;
     ...
     * @return <tt>sigmoid(v)</tt> double between 0 and 1
     */
     ...
     *
     * @param argument between 0 and 1 (exclusively)
     * @return <tt>sigmoid'(v)</tt>
     */
    protected double activationDiff(double v) {
        double a = activation(v);
        return a * (1 - a);
    }
