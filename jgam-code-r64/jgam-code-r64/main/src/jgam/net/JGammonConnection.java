...
public class JGammonConnection implements GameConnection {
    ...
    private void receiveSetup() throws IOException, JGamProtocolException {
        ...
        if (line.equals("NEWGAME")) {
            ...
            setup = BoardSnapshot.decodeBase64(line.substring(11));
        } else {
    ...
    private void sendSetup() throws IOException {
        ...
        if (setup == null) {
            ...
            writer.write("SETUPBOARD " + BoardSnapshot.encodeBase64(setup) + "\n");
        }
        ...
        Runnable diceJob = new Runnable() {
            public void run() {
                try {
                    ...
                    game.sendPlayerMessage(new PlayerMessage(null, PlayerMessage.MessageType.DICES, secureDice.getDice()));
                } catch (Exception ex) {
                    throw new Error(ex);
                }
            }
