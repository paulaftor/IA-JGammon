...
public class Chatter extends JFrame implements ChannelListener {
    ...
    synchronized public void receiveChannelMessage(int channel, String message) {
    ...
    public void addMsg(String message, boolean remote) {
        ...
        String name = remote ? remoteName : localName;
