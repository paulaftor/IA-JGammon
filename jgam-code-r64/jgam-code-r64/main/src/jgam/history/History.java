...
public class History extends AbstractTableModel implements JToolTipTable.ToolTipper {
    ...
    private List<HistoryMessage> entries = new ArrayList<HistoryMessage>();
    ...
    public void addMove(SingleMove m) {
        moveMessage.add(m);
        fireTableDataChanged();
    }
    ...
    public String getColumnName(int columnIndex) {
        ...
        case 1:
            if (game == null) {
                ...
                String color = JGammon.jgammon().getBoard().getColorName(1);
                return game.getPlayer1().getName() + " (" + color + ")";
            }
        case 2:
            if (game == null) {
                return namePlayer2;
            } else {
                String color = JGammon.jgammon().getBoard().getColorName(2);
                return game.getPlayer2().getName() + " (" + color + ")";
            }
     ...
     */
    public List<SingleMove> getMovesForIndex(int index) {
        if (index < entries.size() && entries.get(index) instanceof MoveMessage) {
     ...
     */
    public List<HistoryMessage> getEntries() {
        return entries;
    }
