...
public class FileBoardSetup extends ArrayBoardSetup {
    ...
    public FileBoardSetup(URL url) throws IOException, FormatException {
    ...
    public FileBoardSetup(Reader reader) throws IOException, FormatException {
        ...
        try {
            ...
            String whiteLine = readLine(reader);
            String blueLine = readLine(reader);
            String turnLine = readLine(reader);
            String cubeLine = readLine(reader);
            String diceLine = readLine(reader);
