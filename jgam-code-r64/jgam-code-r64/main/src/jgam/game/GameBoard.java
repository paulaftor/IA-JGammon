...
public class GameBoard extends BoardSetup {
     ...
     * @param player the number of the player whose move it is
     *
     * @param move a Move, not necessarily a SingleMove
     */
    /*package*/ void performMove(SingleMove sm) {
