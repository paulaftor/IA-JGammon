 ...
 * @version 1.0
 * @deprecated gnubg does no longer support this "server mode"
 */
@Deprecated
public class GnuBgAI implements AI {
     ...
     */
    public synchronized MoveChain makeMoves(BoardSetup boardSetup) {
        try {
            ...
            MoveChain mc = new MoveChain();
            for (int i = 0; i < strings.length; i++) {
                mc.add(new SingleMove(player, strings[i]));
            }
            return mc;
