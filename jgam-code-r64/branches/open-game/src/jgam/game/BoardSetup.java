...
/**
 * That is the basic class describing a situation on a backgammon board.
 * The following data are stored:
 * <ul>
 *   <li>Checkers' positions for both parties
 *   <li>Dice
 *   <li>Double cube + who may use it
 *   <li>Player at move, or whether this determined by the dice
 * </ul>
 * 
 * There are a couple of convenience methods to access the fields.
 * 
