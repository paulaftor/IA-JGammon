...
public class ProbRaceNeuralNetAI extends NeuralNetAI {
    ...
    public static final int NUMBER_OF_RACE_FEATURES = 50;
    ...
    public static double[] extractFeatures(BoardSetup setup, double[] features) {
        ...
        features[48] = setup.calcPip(player);
        features[49] = setup.calcPip(3 - player);
     ...
     * 
     * instead of 0 .. 1 make the desired values 0.2 .. 0.8
     * 
     * so: (res-.2)/.6 (check for <0, >1)
     * 
     */
