 ...
 * 
 * 1. "normal" AI ---> FeatureEvaluator 2. race condition ---> RaceAI 3. bearing
 * off ---> BearoffAI
 * 
 * @author Mattias Ulbrich
 * @version 1.0
 */
public class CombiAI extends EvaluatingAI {

    public static enum Mode {
        NORMAL, BEAROFF, RACE, UNSEPARATED_BEAROFF
    }
    
    public AI fallbackAI = new RandomAI();
    
    public EnumMap<Mode, AI> mapAI = 
            new EnumMap<Mode, AI>(Mode.class);
    ...
    public String getDescription() {
        return "Combination of different specialised AIs";
    }
     ...
     * @throws CannotDecideException
     */
    public double propabilityToWin(BoardSetup boardSetup)
            throws CannotDecideException {
        ...
        if (ai instanceof EvaluatingAI) {
            ...
            return evalAI.propabilityToWin(boardSetup);
        } else {
